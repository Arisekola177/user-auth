    ...
    <div className="w-full flex justify-center items-center px-6 h-screen">
      <div className="bg-white rounded-md shadow-md w-[400px] h-auto py-10 px-6">
        ...
        <div>
          ...
          <Link href="/forgotPassword" className="py-2 text-xs text-slate-800">
            Forget Password?
          </Link>
          <p className="text-xs mt-4 text-center font-medium">
            Don&apos;t have an account? <Link className="text-blue-500 hover:underline duration-300" href="/register">Register</Link> here
          </p>
        </div>
      </div>
    </div>
